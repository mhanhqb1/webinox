<div id="list_banner">
    <img src="<?php echo BASE_URL ?>/img/tmp/item_banner.jpg" title="" alt=""/>
</div>

<div id="list_tools">
    <div class="list_tools_btn crisp" id="list_tools_sort"></div>
    <div class="list_tools_btn crisp" id="list_tools_filter"></div>
</div>
...
<?php echo $this->element('popup/sort'); ?>
<?php echo $this->element('popup/filter'); ?>